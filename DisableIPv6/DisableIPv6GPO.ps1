...
$gpo = New-GPO -Name DisableIPv6 -Comment "Disables IPv6"
Start-Sleep -s 5
...
Copy-Item .\disableIPv6.ps1 "C:\Windows\SYSVOL\sysvol\$forest\Policies\{$guid}\Machine\Scripts\Startup"

$pshellscript = @"

[Startup]
0CmdLine=disableIPv6.ps1
0Parameters=
"@
